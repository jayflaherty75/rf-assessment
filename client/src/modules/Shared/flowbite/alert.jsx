...
const styles = {
    ...
    'warn': 'p-4 mb-4 text-sm text-yellow-700 bg-yellow-100 rounded-lg dark:bg-yellow-200 dark:text-yellow-800',
    'error': 'p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800',
};

const Alert = ({ message, level, onClick }) => (
    <div className={styles[level || 'info']} role="alert" onClick={onClick}>
        {message}
    </div>
);
